...
export interface PurchaseConsumerInterface extends utils.Interface {
  functions: {
...
export interface PurchaseConsumer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PurchaseConsumerInterface;
