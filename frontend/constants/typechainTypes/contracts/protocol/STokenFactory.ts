...
export declare namespace STokenFactory {
...
export interface STokenFactoryInterface extends utils.Interface {
  functions: {
...
export interface STokenFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: STokenFactoryInterface;
  ...
  functions: {
    ...
    ): Promise<[STokenFactory.STokenWithDataStructOutput[]]>;
